...
Once ITS2 sequences were obtained, this project combined LotuS2, Funguild, and R to assess 
(1) the abundance and occurence of soil fungal OTUs in Prospect Basin Fens, and
(2) the differences (if any) in soil fungal communities with respect to two variables: _peat accumulation_ (samples within the fen boundary) and _vaccinium presence_
