...
the abundance and occurence of soil fungal OTUs in Prospect Basin Fens, and the differences (if any) in soil fungal communities with respect to two variables: _peat accumulation_ (samples within the fen boundary) and _vaccinium presence_
